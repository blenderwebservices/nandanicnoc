            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                    ...
                    <ul class="space-y-2 text-sm text-gray-600">
                        @if($nanda->approval_year)
                            <li class="flex items-start gap-2"><span
                                    class="font-medium whitespace-nowrap">{{ __('Approved') }}:</span>
                                <span>{{ $nanda->approval_year }}</span>
                            </li>
                        @endif
                        @if($nanda->evidence_level)
                            <li class="flex items-start gap-2"><span
                                    class="font-medium whitespace-nowrap">{{ __('Evidence Level') }}:</span>
                                <span>{{ $nanda->evidence_level }}</span>
                            </li>
                        @endif
                        @if($nanda->diagnosis_status)
                            <li class="flex items-start gap-2"><span
                                    class="font-medium whitespace-nowrap">{{ __('Status') }}:</span>
                                <span>{{ $nanda->diagnosis_status }}</span>
                            </li>
                        @endif
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-600">
                        @if($nanda->focus)
                            <li class="flex items-start gap-2"><span
                                    class="font-medium whitespace-nowrap">{{ __('Focus') }}:</span>
                                <span>{{ $nanda->focus }}</span>
                            </li>
                        @endif
                        @if($nanda->judgment)
                            <li class="flex items-start gap-2"><span
                                    class="font-medium whitespace-nowrap">{{ __('Judgment') }}:</span>
                                <span>{{ $nanda->judgment }}</span>
                            </li>
                        @endif
                    </ul>
                </div>
