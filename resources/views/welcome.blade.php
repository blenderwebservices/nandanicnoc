...
<body
    ...
    <!-- PWA Install Banner -->
    <div id="pwa-banner"
        class="hidden fixed top-0 left-0 w-full z-[100] p-4 animate-in fade-in slide-in-from-top duration-500">
        <div
            class="max-w-xl mx-auto bg-white/80 dark:bg-[#161615]/80 backdrop-blur-md border border-[#19140035] dark:border-[#3E3E3A] rounded-xl shadow-2xl p-4 flex items-center gap-4 transition-all hover:scale-[1.01]">
            <div class="shrink-0 w-12 h-12 rounded-lg overflow-hidden border dark:border-[#3E3E3A] shadow-sm">
                <img src="/icon-192.png" alt="App Icon" class="w-full h-full object-cover">
            </div>
            <div class="flex-1">
                <h3 class="text-sm font-semibold dark:text-white">Instalar NANDA</h3>
                <p id="pwa-text" class="text-xs text-[#706f6c] dark:text-[#A1A09A]">Añade NANDA a tu pantalla de inicio
                    para un acceso rápido y offline.</p>
            </div>
            <div class="flex items-center gap-2">
                <button id="pwa-install-btn"
                    class="px-4 py-2 bg-[#f53003] hover:bg-[#d42a02] text-white text-xs font-medium rounded-lg transition-colors shadow-lg shadow-red-500/20">
                    Instalar
                </button>
                <button id="pwa-close-btn"
                    class="p-2 text-[#706f6c] hover:text-black dark:text-[#A1A09A] dark:hover:text-white transition-colors">
    ...
    <script>
        ...
        if (!isStandalone && !isDismissed) {
            if (isIOS) {
                ...
                pwaText.innerText = 'Pulsa el botón de compartir y luego "Añadir a la pantalla de inicio".';
